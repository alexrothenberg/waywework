...
task :load_data => :environment do
  Feed.create!(:author=>'Pat Shaughnessy',        :feed_url=>'http://patshaughnessy.net/feed/atom.xml',              :url=>'http://patshaughnessy.net', :name=>'Pat Shaughnessy - Home')
  ...
  Feed.create!(:author=>'Alex Rothenberg',        :feed_url=>'http://alexrothenberg.blogspot.com/feeds/posts/default', :url=>'http://alexrothenberg.blogspot.com/', :name=>'Common Sense Software')
  Feed.create!(:author=>'Queenie Takes Manhattan', :feed_url=>'http://queenietakesmanhattan.blogspot.com/feeds/posts/default', :url=>'http://queenietakesmanhattan.blogspot.com/', :name=>'Queenie Takes Manhattan')
